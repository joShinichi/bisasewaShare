 ...
 */
public class SuccessSearchActivityAdapter extends RecyclerView.Adapter<SuccessSearchActivityAdapter.UserAdapterHolder> {
   ArrayList<KategoriUmum> umums = new ArrayList<KategoriUmum>();
    ...
    public SuccessSearchActivityAdapter(ArrayList<KategoriUmum> umums, Context context, RecyclerView recyclerView){
        this.umums = umums;
    ...
    public UserAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_layout_grid_change,parent,false);
